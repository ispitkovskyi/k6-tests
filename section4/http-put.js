...
export default function() {
    ...
    const crocData = crocResp.json()

    crocodile = {
        name: "UPDATED" + crocData.name,
        sex:  crocData.sex,
        date_of_birth: crocData.date_of_birth,
        age: crocData.age
    }

    const updatedCrocResp = http.put(myCrocUrl, JSON.stringify(crocodile), authenticatedParams)
}